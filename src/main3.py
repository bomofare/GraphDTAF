...
from modeltrytry import DeepDTAF, test
...
if __name__ == '__main__':
    ...
    # schedulerdown = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[40, 80, 120], gamma=0.1, last_epoch=-1)
